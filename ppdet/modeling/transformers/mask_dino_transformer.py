    ...
    def forward(self,
        ...
        for i, layer in enumerate(self.layers):
            ...
            ref_points = F.sigmoid(
                bbox_head(output) + inverse_sigmoid(ref_points))
...
class MaskDINO(nn.Layer):
    ...
    def __init__(self,
        ...
        self._build_input_proj_layer(in_feats_channel)
        ...
        encoder_layer = DeformableTransformerEncoderLayer(
            ...
            num_levels, num_encoder_points, 1.0, weight_attr, bias_attr)
    ...
    def _build_input_proj_layer(self, in_feats_channel):
    ...
    def _get_decoder_input(self,
        ...
        # concat contrastive denoising query
        if self.learnt_init_query:
