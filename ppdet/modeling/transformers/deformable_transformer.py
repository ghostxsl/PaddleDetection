...
from .detr_transformer import MultiHeadAttention
from .utils import *
...
class MSDeformableAttention(nn.Layer):
    ...
    def _deformable_attention_function(self, value, value_spatial_shapes,
    ...
    def forward(self,
        ...
        output = self._deformable_attention_function(
