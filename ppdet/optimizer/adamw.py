...
try:
    import paddle._legacy_C_ops as _C_ops
except:
    import paddle._C_ops as _C_ops
from .plsc_opt import Optimizer
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                if getattr(p, 'has_sparse_grad', None):
                    ...
                    sub_exp_avg_sq = paddle.gather(exp_avg_sq, index, axis=axis)
                    ...
                    _, _, _, _, _, _ = _C_ops.adamw(
                        ...
                        'min_row_size_to_use_multithread', 1000, 'beta1', beta1,
                        'beta2', beta2, "with_decay", with_decay, 'coeff',
                        group['weight_decay'], 'multi_precision',
